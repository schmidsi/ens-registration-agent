...
- `name` (string): ENS name (must end with .eth)
- `years` (number, default: 1): Registration duration
- `owner` (string): Owner - accepts Ethereum address (0x...) or any
  ENS-resolvable name
...
- [AI Agents Directory](https://aiagentsdirectory.com/) — 2,100+ agents, 73+
  categories
- [awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) — popular
  GitHub list
- [AI Agent Store](https://aiagentstore.ai/) — marketplace with free listing
- [TrillionAgent](https://trillionagent.com) — free to submit
- [Google Cloud Agent Finder](https://cloud.withgoogle.com/agentfinder/) —
  Google's directory
